...
class WorkerEntreprise extends StatefulWidget {
  ...
  @override
  _WorkerEntrepriseState createState() => _WorkerEntrepriseState();
}

class _WorkerEntrepriseState extends State<WorkerEntreprise> {
